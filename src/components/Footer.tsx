    ...
    <footer className="bg-green-900 text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="text-green-200 mb-4 max-w-md">
              Your trusted source for beautiful plants and gardening supplies. 
              We help you create the perfect green space for your home and office.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/admin" className="text-green-200 hover:text-white transition-colors">
                  Admin Panel
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <div className="space-y-2 text-green-200">
              <p>📍 123 Plant Street, Garden City</p>
              <p>📞 (555) 123-4567</p>
              <p>✉️ info@plantstore.com</p>
              <p>🕒 Mon-Fri: 9AM-6PM</p>
            </div>
          </div>
        </div>
        ...
        <div className="border-t border-green-800 mt-8 pt-8 text-center text-green-200">
          <p>&copy; 2024 PlantStore. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
